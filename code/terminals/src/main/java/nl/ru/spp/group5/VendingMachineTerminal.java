...
public class VendingMachineTerminal extends Terminal {
    ...
    public static void main(String[] args) {
        ...
        } catch (FileNotFoundException | IOException | NoSuchAlgorithmException | InvalidKeySpecException e) {
            System.out.println("Error initializing the vending machine terminal. Please try again.");
        }
    }
    ...
    public void handleCard(CardChannel channel) {
        ...
        } catch (InterruptedException | BadPaddingException | NoSuchPaddingException | IllegalBlockSizeException | InvalidKeySpecException | NoSuchAlgorithmException | InvalidKeyException | SignatureException | CardException e) {
            System.out.println("An error occurred while handling the card. Please try again.");
        }
    }
    ...
    public static void buySeasonTicket(CardChannel channel, RSAPublicKey terminalPubKey, RSAPrivateKey terminalPrivKey) {
        try {
            ...
            scanner.nextLine();
            Utils.clearScreen();
        } catch (SignatureException | InvalidKeyException | NoSuchAlgorithmException | InvalidKeySpecException | NoSuchPaddingException | IllegalBlockSizeException | BadPaddingException | CardException e) {
            System.out.println("Couldn't buy the season ticket. Please try again.");
        }
    }
    ...
    public static void buyTenEntryTicket(CardChannel channel, RSAPublicKey terminalPubKey, RSAPrivateKey terminalPrivKey) {
        try {
            ...
            System.out.println("Couldn't buy the 10-entry ticket. Please try again.");
        }
    }
    ...
    public static void buyNewCard(CardChannel channel, RSAPublicKey terminalPubKey, RSAPrivateKey terminalPrivKey) {
        try {
            ...
            scanner.nextLine();
            Utils.clearScreen();
        } catch (InterruptedException | SignatureException | InvalidKeyException | NoSuchAlgorithmException | CardException e) {
            System.out.println("Couldn't issue the new card. Please try again.");
        }
    }
    ...
    public static void blockCard(String cardID) {
        try {
            ...
            System.out.println("Couldn't block the card. Please try again.");
        }
    }
}
